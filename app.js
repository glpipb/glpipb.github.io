...
const knowledgeBaseHTML = `<h1>💡 Base de Conocimiento</h1><div class="add-new-button-container"><input type="text" id="kb-search-input" placeholder="🔍 Buscar en artículos por título, categoría o contenido..." style="width: 100%; padding: 12px; border-radius: 8px; border: 1px solid var(--border-color);"><button id="add-kb-article-btn" class="btn-blue">Crear Artículo</button></div><div id="kb-grid-container" class="kb-grid"></div>`;
...
const inventoryCategoryConfig = {
    ...
    fields: { 
        ...
        os: { label: 'Licencia de SO Asignada', type: 'select', optionsSource: 'software-licenses' },
...
// --- AÑADIR NUEVO --- (Funciones completas para la Base de Conocimiento)
    ...
    try {
        ...
        document.getElementById('delete-kb-btn').addEventListener('click', async () => {
            if (confirm('¿Estás seguro de que quieres eliminar este artículo?')) {
                ...
                actionModal.classList.add('hidden');
                // Forzamos el renderizado para que la vista se actualice
                const appContent = document.getElementById('app-content');
                renderKnowledgeBase(appContent);
            }
        });
