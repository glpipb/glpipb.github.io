...
document.addEventListener('DOMContentLoaded', () => {
    ...
    appContent.addEventListener('click', e => {
        ...
        if (target.matches('.edit-btn, .edit-btn *')) {
            ...
            } else { // Para solicitantes y ubicaciones
